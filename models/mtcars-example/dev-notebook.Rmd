...
rmonic::list_to_env(yaml::read_yaml(file.path(k_path_mtcars, "config.yml")))
query <- rmonic::compose_tags("model_uid" = model_config[["model_metadata"]]$model_uid)
predictions_full_table <- rmonic::retrieve_table(tags = query, path = model_archive) 
```
